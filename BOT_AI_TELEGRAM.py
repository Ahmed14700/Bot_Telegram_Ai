...
try:
    ...
    print(f"Init Telegram update error: {e}")
    ...
    try:
        ...
        if data.get("result"):
            ...
            if "text" in last_msg.get("message", {}):
                ...
                # 2. إرسال لـ Webhook n8n (تم تفعيله بالكامل)
        ...
        print(f"Loop error caught to prevent crash: {outer_e}")
